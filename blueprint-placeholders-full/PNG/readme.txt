...
span-1 to span-24 (e.g. span-4.png) and are overlaid with the images's
...
The format for grid-based images is simple:
    ...
    span-[number of columns]-rows-[number of rows].png

e.g. images/grid/span-4-rows-5.png (150 x 90)
     images/grid/span-5-rows-4.png (190 x 72)
...
The format for ratio-based images is simple:
    ...
    span-[number of columns].png
        Standard (4:3) ratio image.

    span-[number of columns]-wide.png
        Widescreen (16:9) ratio image.

e.g. images/ratio/span-12.png      (470 x 352)
     images/ratio/span-12-wide.png (470 x 264)
...
e.g. images/ratiogrid/span-12.png      (470 x 342)
     images/ratiogrid/span-12-wide.png (470 x 270)
...
The format for square images is simple:
    ...
    rows-[number of rows].png
        Square determined by the height of the rows.

e.g. images/square/span-12.png (470 x 470)
     images/square/rows-12.png (216 x 216)
...
websites, content licenses, etc. This set contains 7 popular sizes:
    ...
    36 x 13
    80 x 15 (also available as 'blueprint.png')
    88 x 31
    110 x 32
    120 x 60
    125 x 50
...
(4) Google maps
Available at the default embed size (425 x 350) as map.png, satellite.png,
terrain.png or earth.png. As I needed these example maps to be of somewhere real
